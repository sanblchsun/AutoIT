...
Func _BASS_EXT_ChannelGetFFT($hHandle, $aFFT, $iFallOff = 6)
	...
	Local $bass_ext_ret = DllCall($_ghBassEXTDll, "bool", "_BASS_EXT_ChannelGetFFT", "dword", $hHandle, "dword", $aFFT[3], "dword", $aFFT[4], "dword", $aFFT[5], "dword", $iFallOff, "bool", $aFFT[6], "ptr", $aFFT[0])
	If @error Then Return SetError(@error, 0, 0)
