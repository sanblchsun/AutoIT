; ќригинал можно скачать по ниже указанным ссылкам. “екущий файл не оригинал, из него удалены бинарные данные FMOD.dll и .mp3-файла
; http://www.autoitscript.com/forum/topic/123293-how-to-play-sound-directly-not-from-file/#entry1004262
; http://www.autoit.de/index.php?page=Attachment&attachmentID=16050&h=ff3c5ca7943b0a3c97e3141f206c7710fe1c1a57
...
Func _FMOD_DLL($bSaveBinary = False)
	Local $FMOD_DLL
	$FMOD_DLL &= 'здесь бинарник FMOD.dll'
...
Func _CaptainFuture($bSaveBinary = False)
	Local $CaptainFuture
	$CaptainFuture &= 'здесь бинарник музыки'
	Local $bString = Binary(_Base64Decode($CaptainFuture))
	If $bSaveBinary Then
		Local $hFile = FileOpen(@ScriptDir & "\Captain Future - HQ & STEREO - German Opening (extended + enhanced).mp3", 18)
		FileWrite($hFile, $bString)
		FileClose($hFile)
	EndIf
	Return  $bString
EndFunc   ;==>_CaptainFuture
