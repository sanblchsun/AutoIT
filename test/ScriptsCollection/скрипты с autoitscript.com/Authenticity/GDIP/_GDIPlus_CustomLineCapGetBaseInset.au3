...
Func _Example()
	...
	$hGUI = GUICreate("_GDIPlus_CustomLineCapGetBaseInset Example", 400, 200)
	GUISetState()
	...
	$hCustomLineCap = _GDIPlus_CustomLineCapCreate(0, $hPath, $LineCapRound)

	; Create CustomLineCap object $hCustomLineCap2 with the base inset of $hCustomLineCap plus 5.
	$nBaseInset = _GDIPlus_CustomLineCapGetBaseInset($hCustomLineCap) + 5
	$hCustomLineCap2 = _GDIPlus_CustomLineCapCreate(0, $hPath, $LineCapRound, $nBaseInset)
