...
Func Example1()
    Local $gui = GUICreate("Example 1: 3D Bar Graph - left=20 (default) top=40", 850, 700)
    ...
    Next
    _CreateBarChart("3D Bar Chart","Example 1",-1,40,500,400)
    GUISetState()
    While 1
        Sleep(10)
        Switch GUIGetMsg()
...
Func Example2()
    Local $gui = GUICreate("Example 2: 3D Bar Graph - Chart at different position", 650, 550)
    GUISetBkColor(0xffffff)
    For $i=0 To 11
        $arNames[$i]=$i+1
    Next
    For $i=0 To 11
        $arValues[$i]=Random(0,200,1)
    Next
    _CreateBarChart("3D Bar Chart","Example 2",50,20,400,450)
    GUISetState()
    While 1
    Sleep(10)
        Switch GUIGetMsg()
...
Func Example3()
    ReDim $arNames[16]
    ReDim $arValues[16]
    Local $gui = GUICreate("Example 3: 3D Bar Graph - Two charts at different positions", 950, 750)
    GUISetBkColor(0xffffff)
    For $i=0 To 15
        $arNames[$i]=$i+1
    Next
    For $i=0 To 15
        $arValues[$i]=Random(0,200,1)
    Next
    _CreateBarChart("3D Bar Chart","Example 3 - without legend",50,80,400,500)
    $arNames=StringSplit("January|February|March|April|May|June|July|August|September|October|November|December|a|b|c|d","|",2)
    _CreateBarChart("3D Bar Chart","Example 3 - with legend",500,100,400,600)
    GUISetState()
    While 1
    Sleep(10)
        Switch GUIGetMsg()
