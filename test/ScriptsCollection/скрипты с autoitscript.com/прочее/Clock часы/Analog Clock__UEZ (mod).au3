; http://www.autoitscript.com/forum/topic/135749-show-a-clock-over-a-full-screen-application/#entry948038
#include <Date.au3>
#include <Timers.au3>
...
If FileExists(@WindowsDir & "fontsshowg.ttf") Then $font = "Showcard Gothic"
;Time init
