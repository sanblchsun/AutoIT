...
; Version........: 1.1 (Apr 28/11) - documentation changed, additional (optional) parameters
...
;                  |To specify a defined window type, append a greater-than (>) character
...
; Parameters.....: $sChmFile	- the name of the CHM file (with path, if needed).
;                  |An (optional) topic (ie. "::/topic_url" may be appended to $sChmFile.
;                  |To specify a defined window type, append a greater-than (>) character
;                  |followed by the name of the window type.
