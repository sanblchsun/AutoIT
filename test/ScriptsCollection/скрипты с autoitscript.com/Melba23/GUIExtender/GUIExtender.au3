...
; [0][4] = -                                                        [n][4] = Section final ControlID
...
; #CURRENT# ==========================================================================================================
; _GUIExtender_Init:           Initialises the GUI containing the sections and sets orientation
...
; Description ...: Initialises the GUI containing the sections and sets orientation
; Syntax.........: _GUIExtender_Init($hWnd, $iOrient = 0)
...
; Syntax.........: _GUIExtender_Section_Extend($iSection, $fExtend = True)
