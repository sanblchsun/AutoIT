...
If $UserIntLang = 0419 Then
	...
	$LngClb='буфер обмена'
	$LngAct='Последнее активное окно'
	$LngDel='Удалить'
	$LngHnt='Подсказка'
...
$Initext='53,255,9,61|Active|AU3_Sample.ini|0|0|0|800|^{F11}'
...
Func _SelEdit()
	...
	EndIf
	$Radio[1] = GUICtrlCreateRadio($LngAct, 15, 35, 470, 17)
	$winClass[1][1]='Active'
	If $aSet[2] == $winClass[1][1] Then
		GUICtrlSetState(-1, $GUI_CHECKED)
		GUICtrlSetBkColor(-1, 0xbbbbbb)
	EndIf
...
'#AutoIt3Wrapper_Res_Field=Version|0.1' & @CRLF & _
'#AutoIt3Wrapper_Res_Field=Build|2011.08.2' & @CRLF & _
'#AutoIt3Wrapper_Res_Field=Coded by|Author' & @CRLF & _
'#AutoIt3Wrapper_Res_Field=Compile date|%longdate% %time%' & @CRLF & _
'#AutoIt3Wrapper_Res_Field=AutoIt Version|%AutoItVer%' & @CRLF & _
...
Local $font="Arial"
	...
	GUICtrlCreateLabel($LngVer&' 0.4   2.08.2011', 15, 100, 210, 17)
