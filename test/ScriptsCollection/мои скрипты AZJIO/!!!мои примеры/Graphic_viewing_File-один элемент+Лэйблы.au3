...
GUICtrlSetTip(-1, 'Список крупных файлов')
...
While 1
    ...
    Select
        ...
        Case $msg = $RE
            _restart()
        Case $msg = $BL
				MsgBox(0, 'Список крупных файлов', $List)
			; If $k <50 Then
				; MsgBox(0, 'Список крупных файлов', $List)
			; Else
...
Func _Create()
    ...
    While 1
		...
		$k+=1
        GUICtrlSetGraphic($a, $GUI_GR_COLOR, 0, Dec(Random(50, 99, 1) & Random(50, 99, 1) & Random(50, 99, 1))) ; цвет сектора, рандомный
        ...
        ;If $grad>20 Then MsgBox(0, 'Сообщение', $nach+$grad/2&@CRLF&cos($rp)&' - cos'&@CRLF&sin($rp)&' - sin')
    ...
    WEnd
        ...
        GUICtrlSetGraphic($a, $GUI_GR_COLOR, 0, 0xe9de12) ; цвет сектора, жёлтый
        GUICtrlSetGraphic($a, $GUI_GR_PIE, 180, 180, 180, $nach, $grad) ; создание сектора
        GUICtrlSetState(-1, 8)
		;$nach += $grad
        ...
        ;GUICtrlSetGraphic($a1, $GUI_GR_COLOR, 0, Dec(Random(50, 99, 1) & Random(50, 99, 1) & Random(50, 99, 1))) ; цвет сектора, рандомный
		...
		$rt+=1
			...
			;MsgBox(0, 'Сообщение', $y[$rt]&' - ID'&@CRLF&$rt&' - №'&@CRLF&$aLab[$i]&' - слева'&@CRLF&$aLab[$i+1]&' - сверху'&@CRLF&$aLab[$i+2])
		Next
