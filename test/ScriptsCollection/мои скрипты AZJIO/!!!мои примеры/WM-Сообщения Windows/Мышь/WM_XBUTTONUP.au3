...
GUICtrlCreateLabel('Функция WM_XBUTTONUP срабатывает в момент отжатия дополнителной кнопки мыши в клиенской области окна.', 5, 5, 380, 34)
GUISetState()

GUIRegisterMsg(0x020C, "WM_XBUTTONUP")
...
Func WM_XBUTTONUP($hWndGui, $MsgId, $wParam, $lParam)
    ...
    ToolTip("X кнопка отжата: " & @LF & "Клавиша: " & _KeysHeld($wParam) & @LF & "X: " & $X & @LF & "Y: " & $Y, Default, Default, "Мышь", 1, 1)
    Return 0
EndFunc
