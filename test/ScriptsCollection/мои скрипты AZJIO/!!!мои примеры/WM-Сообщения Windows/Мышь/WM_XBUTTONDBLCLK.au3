...
$Gui = GUICreate("Двойной клик дополнительной кнопкой мыши", 400, 150)
GUICtrlCreateLabel('Функция WM_XBUTTONDBLCLK срабатывает в момент двойного клика мыши дополнителной кнопкой в клиенской области окна.', 5, 5, 380, 34)
GUISetState()

GUIRegisterMsg(0x020D, "WM_XBUTTONDBLCLK")
...
Func WM_XBUTTONDBLCLK($hWndGui, $MsgId, $wParam, $lParam)
    ...
    ToolTip("X кнопка двойной клик: " & @LF & "Клавиша: " & _KeysHeld($wParam) & @LF & "X: " & $X & @LF & "Y: " & $Y, Default, Default, "Мышь", 1, 1)
    Return 0
EndFunc
