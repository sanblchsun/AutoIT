...
GUICtrlCreateLabel('Функция WM_RBUTTONUP срабатывает в момент отжатия правой кнопки мыши в клиенской области окна.', 5, 5, 380, 34)
GUISetState()

GUIRegisterMsg(0x0205, "WM_RBUTTONUP")
