...
GUICtrlCreateLabel('Функция WM_NCRBUTTONUP срабатывает в момент отпускания правой кнопки мыши в НЕ клиенской области окна, точнее на заголовке и краях окна, когда курсор меняется на изменение размеров окна.', 5, 5, 440, 74)
GUISetState()
